...
const DashPortal = ({
  ...
  const Login = async (username, password) => {
    try {
      const response = await fetch('https://chainco-backend.onrender.com/api/auth/login', {
        method: 'POST',
  ...
  const Signup = async (username, email, password) => {
    try {
      const response = await fetch('https://chainco-backend.onrender.com/api/auth/signup', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
  ...
  const RecoverId = async (email) => {
    try {
      const response = await fetch('https://chainco-backend.onrender.com/api/auth/recover-id', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
